class ProductsController < ApplicationController
  ...
  def product_params
    params.require(:product).permit(:id, :name, :description, :item_number,  :ordering_number, :vendor, :active, :product_page_url, :product_image, :account_id, :hide_display_price)
  end
